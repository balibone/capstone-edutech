...
public class SystemuserFacadeREST extends AbstractFacade<Systemuser> {
    ...
    @POST @Override @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    ...
    public List<Systemuser> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
