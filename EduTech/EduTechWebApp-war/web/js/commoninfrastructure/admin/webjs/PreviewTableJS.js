...
//                    alert(status+": "+error+". Please ensure usernames in CSV do not duplicate with any existing usernames and that your CSV is formatted according to the example CSV.");
                    alert("Error: Please ensure usernames in CSV do not duplicate with any existing usernames and that your CSV is formatted according to the example CSV.");
                }
            });
        }
    });
