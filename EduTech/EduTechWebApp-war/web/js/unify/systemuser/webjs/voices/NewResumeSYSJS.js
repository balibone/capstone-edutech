...
$(document).ready(function () {
    ...
    $('#workExprBtn').click(function() {
        ...
        var row_2 = '<tr class="workExpr workExpr-'+workExpr_count+'" >\n\
                            ...
                            <td valign="middle"><b><center>Period: </center></b></td>\n\
                            <td valign="middle"><input type="text" class="form-control" name="workPeriod[]" style="margin-right: 10px; width: 50%"/></td></tr>';
    ...
    $('#referenceBtn').click(function() {
        ...
        var row_2 = '<tr class="reference reference-'+reference_count+'">\n\
                            ...
                            <td valign="middle"><input type="text" class="form-control" name="refPosition[]" style="margin-right: 10px; width: 50%"/></td></tr>';
...
function createWorkExprList() {
    ...
    document.getElementById("pageTransit").value = "createResumeSYS";
