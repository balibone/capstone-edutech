...
$(document).ready(function () {
    ...
    map.locate({setView: true, watch: true}).on('locationfound', function (e) {
        ...
        if(layer_marker) { json_group.clearLayers(layer_marker); }
        for(i = 0; i < json_response.length; i++) {
            ...
            if(jsonDataDistDiff < 1) { json_group.addLayer(layer_marker); }
        }
...
function degreeToRadian(deg) { return deg * (Math.PI/180); }