...
<html lang="en">
    ...
    <body onload="establishTime(); setInterval('updateTime()', 1000)">
        <div id="wrapper">
            ...
            <!-- Content Space -->
            <div id="page-wrapper">
                <form action="CommonInfra" method="POST" onsubmit="return confirm('Confirm deactivate the selected employee(s)?');">
                    <div class="contentFill contentLayout" style="padding-top: 15px; height: 65px;">
                        ...
                        <button type="button" class="btn btn-primary pull-right" style="margin-right: 20px;" onclick="location.href='CommonInfra?pageTransit=goToNewEmployee'">
