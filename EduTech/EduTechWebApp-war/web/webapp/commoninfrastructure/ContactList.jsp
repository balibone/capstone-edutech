...
<html lang="en">
    ...
    <body onload="establishTime(); setInterval('updateTime()', 1000)">
        <div id="wrapper">
                ...
                <div class="navbar-default sidebar">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li><a href="Warehouse?pageTransit=goToPackageListt"><i class="fa fa-shopping-bag fa-fw"></i>&nbsp;&nbsp;Purchase Orders</a></li>
            ...
            <!-- Content Space -->
            <div id="page-wrapper">
                <form action="CommonInfra" method="POST" onsubmit="return confirm('Confirm deactivate the selected contact(s)?');">
                    <div class="contentFill contentLayout" style="padding-top: 15px; height: 65px;">
                        ...
                        <button type="button" class="btn btn-primary pull-right" style="margin-right: 20px;" onclick="location.href='CommonInfra?pageTransit=goToNewContact'">
