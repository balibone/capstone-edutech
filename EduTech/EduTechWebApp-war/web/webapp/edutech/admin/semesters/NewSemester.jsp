                        ...
                        <form id="thisForm" action="EduTechAdmin" method="POST" class="form-horizontal">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-8"> 
                                    ...
                                    <input type="hidden" name="pageTransit" value="createSemester"/>
                                    <button type="submit" class="btn btn-primary" value="submit">Create Semester</button>
