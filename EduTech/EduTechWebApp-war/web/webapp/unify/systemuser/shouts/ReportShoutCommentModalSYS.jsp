...
<html lang="en">
    <head>
        ...
        <title>Unify Marketplace - Report Shout Comment</title>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <%
                                String reportShoutCommentID = (String) request.getAttribute("reportShoutCommentID");
                                String reportShoutCommentContent = (String) request.getAttribute("reportShoutCommentContent");
                                String reportShoutCommentShoutID = (String) request.getAttribute("reportShoutCommentShoutID");
                            %>
                            ...
                            <div class="x_content">
                                <p>Share what is wrong with this comment:</p>
                                <p><i><%=reportShoutCommentContent%></i></p>
                                <p><i>(<span class="asterik">*</span>) Your report is kept anonymous and confidential</i></p>
                                    ...
                                    <form class="form-horizontal form-label-left" action="ShoutsSysUser" method="POST" enctype="form-data">
                                            ...
                                            <div class="form-row" style="justify-content: center;">
                                                ...
                                                <div class="col-md-2">
                                                <input type="hidden" name="pageTransit" value="goToReportShoutCommentSubmit" />
                                                ...
                                                <a href="ShoutsSysUser?pageTransit=goToViewShoutCommentModalSYS&hiddenShoutID=<%= reportShoutCommentShoutID%>"><button class="btn btn-outline-warning btn-primary btn-sm btn-block"  type="cancel">Cancel</button></a>
                            </div>
                            </div>
                        </div>
                    </div>
