<%-- 
  ...
  - Version:            1.0
  - Credits to:         NIL
  - Description:        User Marketplace Transaction List (Marketplace)
  --%>
...
<html lang="en">
    <head>
        ...
        <title>Unify - My Marketplace Transactions</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="title"><span>My Marketplace Transactions</span></div>
