...
<html lang="en">
    <head>
        ...
        <title>Unify - My Company Review List</title>
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">
                        <div class="title"><span>Company Review List</span></div>
                        <div class="table-responsive">
                            <table id="companyReviewTable" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%" style="font-size: 13px;">
                                <thead>
                                    <tr>
                                        <th>Date</th>
                                        <th>Company</th>
                                ...
                                <tbody>
                                    <%
                                        ArrayList<Vector> companyReviewListSYS = (ArrayList) request.getAttribute("companyReviewListSYS");
                                        if (!companyReviewListSYS.isEmpty()) {
                                            for (int i = 0; i <= companyReviewListSYS.size()-1; i++) {
                                                Vector v = companyReviewListSYS.get(i);
                                                String reviewID = String.valueOf(v.get(0));
        ...
        <script src="js/unify/systemuser/webjs/userprofile/UserCompanyReviewJS.js" type="text/javascript"></script>
    </body>
</html>