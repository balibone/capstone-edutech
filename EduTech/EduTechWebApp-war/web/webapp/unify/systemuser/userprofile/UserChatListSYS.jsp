...
<html lang="en">
    <head>
        ...
        <title>Unify Marketplace - My Marketplace Chats</title>
        ...
        <link href="css/unify/systemuser/weblayout/userprofile/UserChatListSYSCSS.css" rel="stylesheet" type="text/css" />
    </head>
    <body>
                ...
                <div id="frame">
                    ...
                    <div class="content">
                        <div class="contact-profile">
                            <img src="images/unifyimages/unknown-user.png" />
                            <p>Unknown</p>
                        </div>
                        <div class="messages">
                            <p class="noChatRecords">There are no chats selected. Click on one of the chats to start!</p>
                        </div>
                        <div class="message-input">
                            <div class="wrap">
                                <input type="text" disabled="disabled" placeholder="Write your message..." />
        ...
        <script src="js/unify/systemuser/webjs/userprofile/UserChatListSYSJS.js" type="text/javascript"></script>
    </body>
</html>