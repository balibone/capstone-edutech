    ...
    <body>
        ...
        <div id="container">
            <div class="sections">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <a target="_parent" href="EventsSysUser?pageTransit=goToViewMyRequestedEventsListingSYS"><div class="card text-center mb-3 bg-light text-dark">
                                <div class="card-block card-title mt-5 mb-5">
                                    <h1 class="mb-3"><i class="fa fa-calendar-plus-o display-2"></i></h1>
                                    <h6>My Requested Events (Pending Approval)</h6>
                                </div>
                                </div></a>
                        </div>
                        <div class="col-sm-4">
                            <a target="_parent" href="EventsSysUser?pageTransit=goToViewMyEventsListingSYS"><div class="card text-center mb-3 bg-light text-dark">
                                <div class="card-block card-title mt-5 mb-5">
                                    <h1 class="mb-3"><i class="fa fa-calendar display-2"></i></h1>
                                    <h6>My Events</h6>
                                </div>
                                </div></a>
                        </div>
                        <div class="col-sm-4">
                            <a target="_parent" href="EventsSysUser?pageTransit=goToViewMyRsvpEventsListingSYS"><div class="card text-center mb-3 bg-light text-dark">
                                <div class="card-block card-title mt-5 mb-5">
                                    <h1 class="mb-3"><i class="fa fa-ticket display-2"></i></h1>
