...
<html lang="en">
    <head>
        ...
        <title>Unify Events - Events Listing</title>
                ...
                <div class="container">
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="EventsSysUser?pageTransit=goToViewEventsListingSYS">Events Listing</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div id="contentArea" class="container jplist" style="margin-bottom: 30px;">
                ...
                <div class="row">
                        ...
                        <div class="collapse d-md-block pt-3 pt-md-0" id="collapseFilter">
                            <div class="row">
                                <div class="col-12 col-sm-6 col-md-12">
                                    ...
                                    <div class="filter-sidebar">
                                        <div class="subtitle" style="margin-bottom: 5px">Search by User</div>
                                        <input type="text" data-path=".eventUsername" class="form-control" placeholder="Search User" 
                    ...
                    <div class="col-lg-9 col-md-8">
                        <div class="title"><span>Events Listing</span></div>
                        <div class="jplist-search sorting-bar">
                            ...
                            <div class="dateSort jplist-drop-down" remove-class-on-xs="mr-3" add-class-on-xs="w-100" 
                                ...
                                <ul>
                                    ...
                                    <li><span data-path=".startDate" data-order="desc" data-type="datetime">Upcoming Last</span></li>
