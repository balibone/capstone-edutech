...
<html lang="en">
    <head>
        ...
        <title>Unify Events - Edit Event Request</title>
                ...
                <div class="container">
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href='EventsSysUser?pageTransit=goToEditEventRequestSYS&hiddenEventRequestID=<%=eventRequestID%>'>Edit Event Request</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_title">
                                <h5>Submit your event request here</h5>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <p>Holding an event in school? <br>Submit your request to be featured on the events listing page for all school members to see :)</p>
                                <p>(<span class="asterik">*</span>) Event must conform to the university's rules and guidelines</p>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 ml-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="eventTitle" rows="1" required="required"><%=eventRequestTitle%></textarea>

                                                <label for="eventDesc">Event Description</label>
                                                <textarea class="form-control" name="eventDesc" rows="3" required="required"><%=eventRequestDesc%></textarea>
