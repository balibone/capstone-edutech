...
<html lang="en">
    <head>
        ...
        <title>Unify Events - Request New Event</title>
                ...
                <div class="container">
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href='EventsSysUser?pageTransit=goToNewEventSYS'>Request New Event</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                                    ...
                                    <div class="form-row" style="justify-content: left">
                                        ...
                                        <div class="col-md-6 ml-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="eventDesc" rows="3" placeholder="Description here" required="required"></textarea>
