...
<html lang="en">
    <head>
        ...
        <title>Unify Events - My RSVP'ed Events Listing</title>
                ...
                <div class="container">
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="ProfileSysUser?pageTransit=goToViewMyEventsListingSYS">My Events Listing</a></li>
                            <li class="breadcrumb-item active" aria-current="page"><a href="EventsSysUser?pageTransit=goToViewMyRsvpEventsListingSYS">My RSVP'ed Events Listing</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div id="contentArea" class="container jplist" style="margin-bottom: 30px;">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">
                        <div class="title"><span>My RSVP'ed Events Listing</span></div>
