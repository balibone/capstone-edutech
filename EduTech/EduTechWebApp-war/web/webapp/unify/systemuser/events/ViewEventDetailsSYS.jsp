...
<html lang="en">
    <head>
        ...
        <title>Unify Events - Event Details</title>
    ...
    <body onload="loadMap()">
        ...
        <%
            ...
            if (eventDetailsVec != null) {
                ...
                eventStatus = (String.valueOf(eventDetailsVec.get(1)));
                eventDesc = (String.valueOf(eventDetailsVec.get(2)));
                eventStart = (String.valueOf(eventDetailsVec.get(3)));
                eventEnd = (String.valueOf(eventDetailsVec.get(4)));
                eventVenue = (String.valueOf(eventDetailsVec.get(5)));
                eventApproveDate = (String.valueOf(eventDetailsVec.get(6)));
                eventCreator = (String.valueOf(eventDetailsVec.get(7)));
                eventTitle = (String.valueOf(eventDetailsVec.get(8)));
                ...
                <div class="container">
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="EventsSysUser?pageTransit=goToViewEventsListingSYS">Events Listing</a></li>
                            <li class="breadcrumb-item active" aria-current="page"><a href='EventsSysUser?pageTransit=goToViewEventDetailsSYS&hiddenEventID=<%=eventID%>'>Event Details</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-7 col-md-6">
                            ...
                            <tbody>
                                <tr class="d-none d-md-table-row">
                                    <td class="border-top-0" colspan="2">
                                        ...
                                        <div class="pull-left"><h4><%= eventTitle%></h4>
                                                <%
                                                    if (eventHappening.contains("Ongoing")) {
                                                %>
                                            <span class="p-1 text-white bg-success">Event Ongoing</span>
                                            <%
                                            } else if (eventHappening.contains("Ended")) {
                                            %>
                                            <span class="p-1 text-white bg-info">Event Ended</span>
                                            <%  }%>
                                        </div>
                                ...
                                <tr>
                                    <td>Event Venue</td>
                                    <td>
                                        <ul class="list-inline mb-0"><li class="list-inline-item"><h5 class="mb-0"><%= eventVenue%></h5></li></ul>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Event Details</td>
                                    <td>
                                        <ul class="list-inline mb-0"><li class="list-inline-item"><h5 class="mb-0"><%= eventDesc%></h5></li></ul>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Event Starts</td>
                                    <td>
                                        <ul class="list-inline mb-0"><li class="list-inline-item"><h5 class="mb-0"><%= eventStart%></h5></li></ul>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Event Ends</td>
                                    <td>
                                        <ul class="list-inline mb-0"><li class="list-inline-item"><h5 class="mb-0"><%= eventEnd%></h5></li></ul>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Event Creator</td>
                                    <td>
                                        <ul class="list-inline mb-0"><li class="list-inline-item"><h5 class="mb-0"><%= eventCreator%>&nbsp;&nbsp;
                                                    <%
                                ...
                                <tr>
                                    <td>Number of RSVP</td>
                                    <td>
                                        <ul class="list-inline mb-0"><li class="list-inline-item"><h5 class="mb-0"><%= rsvpCount%></h5></li></ul>
                                    </td>
                                </tr>
                                <tr>
                                    <td>RSVP Status</td>
                                    ...
                                    <%  if (!eventHappening.contains("Ended")) {%>
                                    <td><a href="EventsSysUser?pageTransit=goToRsvpToEventSYS&hiddenEventID=<%= eventID%>"><span class="p-1 text-white bg-info">Click here to RSVP to event</span></a></td>
                                    <%  } else {%>
                                    <td><span class="p-1 text-white bg-info">Did not RSVP to event</span></a></td>
                                    <%  }
                                        }%>
                                </tr>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link text-default" id="reportPane-tab" data-toggle="tab" href="#reportPane" role="tab" aria-controls="reportPane" aria-selected="true">Report Event</a></li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div class="tab-pane border border-top-0 p-3" id="reportPane" role="tabpanel" aria-labelledby="reportPane-tab">
                                <table class="table table-bordered mb-0">
                                    <tbody>
                                        <tr>
                                            <td class="bg-light w-25">Report this event</td>
                                            <td>
                                                <div class="x_content">
                                                    <p>Share what is wrong with this event:</p>                                                    
                                                    ...
                                                    <form class="form-horizontal form-label-left" action="EventsSysUser" method="POST" enctype="form-data">
                                                        ...
                                                        <div class="form-row" >
                                                            ...
                                                            <div class="col-md-9 ml-9">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="eventReportContent"></label>
                                                                    <textarea class="form-control" name="eventReportContent" rows="3" placeholder="Describe why you are writing this report here" required="required"></textarea>
                                                                </div>
                                                        ...
                                                        <div class="form-row" style="justify-content: left;">
                                                            ...
                                                            <div class="col-md-2">
                                                                <input type="hidden" name="pageTransit" value="goToReportEventSubmit" />
