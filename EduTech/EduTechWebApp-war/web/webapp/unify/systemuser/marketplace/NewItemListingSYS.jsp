                                    ...
                                    <form class="form-horizontal form-label-left" action="MarketplaceSysUser" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="col-md-3 ml-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-sm input-group-qty">
                                                            ...
                                                            <input type="text" class="form-control" name="itemPrice" aria-label="itemPrice" value="1" data-min="1" data-max="9999" required="required" />
                                        ...
                                        <div id="step-2">
                                            <div class="form-row" style="justify-content: center;">
                                                ...
                                                %>
                                                <div class="col-sm-3">
                                                    <div class="card text-center" id="<%= categoryID%>">
                                                        <div class="card-body">
                                                            <img src="uploads/unify/images/common/category/<%= categoryImage%>" style="width: 100px; height: 100px;" /><br/>
                                            ...
                                            <div class="form-row" style="justify-content: center;">
                                                ...
                                                <div class="col-md-6 ml-4">
                                                    ...
                                                    <div class="form-group" style="text-align: center;">
                                                        <button type="submit" class="btn btn-primary">Create New Listing</button></form>
                                                    </div>
                                                </div>
