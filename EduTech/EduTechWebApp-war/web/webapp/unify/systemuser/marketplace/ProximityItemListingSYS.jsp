<%-- 
  ...
  - Version:            1.0
  - Credits to:         NIL
  - Description:        Marketplace Listings Near Me - Proximity 1KM (Marketplace)
  --%>
...
<html lang="en">
    <head>
        ...
        <title>Unify Marketplace - Item Listing Around Me</title>
        ...
        <link href="css/unify/systemuser/weblayout/marketplace/ProximityItemListingSYSCSS.css" rel="stylesheet" type="text/css" />
    </head>
    <body>
            ...
            <div class="container" style="margin-bottom: 30px;">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h5>Item Listing Around Me</h5>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <div id="mapdiv" style="height:450px;width:content-box;margin-top:15px;"></div>
                                <input type="hidden" id="jsonResponse" value='<%= request.getAttribute("jsonResponse")%>' />
                            </div>
                        </div>
                    </div>
                </div>
