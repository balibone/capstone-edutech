...
<html lang="en">
    <head>
        ...
        <title>Unify Admin - Company Requests</title>
        ...
        <script type="text/javascript" src="js/unify/admin/webjs/voices/ViewCompanyRequestListJS.js"></script>
    </head>
            ...
            <div id="content">
                <div class="container">
                    ...
                    <div class="page-header">
                        ...
                        <ul class="page-stats">
                            <li>
                                <div class="summary"><span>Solved Requests</span><h3><%= request.getAttribute("solvedCompanyRequestListCount")%></h3></div>
                            ...
                            <div class="widget box">
                                ...
                                <div class="widget-content no-padding">
                                    <table id="companyRequestListing" class="table table-striped table-bordered table-hover table-checkable table-responsive datatable">
                                        ...
                                        <tbody>
                                            <% 
                                                ArrayList<Vector> companyRequestList = (ArrayList) request.getAttribute("companyRequestList");
                                                if (!companyRequestList.isEmpty()) {
                                                    for (int i = 0; i <= companyRequestList.size()-1; i++) {
                                                        Vector v = companyRequestList.get(i);
                                                        String requestDate = String.valueOf(v.get(0));
                                                        String requestPoster = String.valueOf(v.get(1));
                                                        String requestCompany = String.valueOf(v.get(2));
                                                        String requestIndustry = String.valueOf(v.get(3));
                                                        String requestComment = String.valueOf(v.get(4));
                                                        String requestStatus = String.valueOf(v.get(5));
                                            %>
                                            <tr>
                                                <% 
                                                ...
                                                <%
                                                    } else if (requestStatus.equals("Solved")) {
                                                %>
                                                <td><%= requestDate%></td>
                                                <td><%= requestPoster%></td>
                                                <td>
