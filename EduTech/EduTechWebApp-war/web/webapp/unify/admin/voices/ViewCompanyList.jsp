...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="js/unify/admin/webjs/voices/ViewCompanyListJS.js"></script>
    </head>
                ...
                <div class="container">
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <h3>Company List</h3><span>Click on each company to view the associated company information.</span>
                        </div>
                        <ul class="page-stats">
                            <li>
                                <div class="summary"><span>Active Company Listing</span><h3><%= request.getAttribute("activeCompanyListingCount")%></h3></div>
                                <div id="sparkline-bar2" class="graph sparkline hidden-xs">20,15,8,50,20,40,20,30</div>
                            </li>
                            <li>
                                <div class="summary"><span>Inactive Company Listing</span><h3><%= request.getAttribute("inactiveCompanyListingCount")%></h3></div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="widget box">
                                <div class="widget-header">
                                    <h4><i class="fa fa-reorder"></i>&nbsp;Company List</h4>
                                    <div class="toolbar no-padding">
                                        <div class="btn-group">
                                            <div class="btn-group">
                                                <span id="newCompany" class="btn btn-xs"><i class="fa fa-plus"></i>&nbsp;Add New Company</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="widget-content no-padding">
                                    <table id="companyList" class="table table-striped table-bordered table-hover table-checkable table-responsive datatable">
                                        <thead>
                                            <tr>
                                                <th data-class="expand">Company Image</th>
                                                <th data-hide="expand">Company Name</th>
                                                <th>Company HQ</th>
                                                <th>Company Size</th>
                                            ...
                                            <%  
                                                ...
                                                if (!companyList.isEmpty()) {
                                                    for (int i = 0; i <= companyList.size()-1; i++) {
                                                        ...
                                                        String companyHQ = String.valueOf(v.get(3));
