<!-- ***************************************************************************************
*   Title:                  NewJobCategory.jsp
*   Purpose:                CREATION OF NEW JOB CATEGORY (UNIFY ADMIN)
...
<html>
    <head>
        ...
        <title>Unify Admin - New Job Category</title>
        ...
        <link href="css/unify/admin/weblayout/errands/NewJobCategoryCSS.css" rel="stylesheet" type="text/css" />
        ...
        <script src="js/unify/admin/webjs/errands/NewJobCategoryJS.js" type="text/javascript"></script>
    </head>
        ...
        <form action="ErrandsAdmin" method="POST" enctype="multipart/form-data" target="_parent">
            <table border="0">
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            <label class="control-label">Category Type:&nbsp;&nbsp;<u>Errands</u></label>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                <textarea rows="5" class="form-control" placeholder="Job Category Description (Required)" required="required" name="categoryDescription"></textarea>
                            </div>
                        </div>
                    </td>
                </tr>
                    ...
                    <td colspan="2">
                        <div class="form-group" style="text-align: center;">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                <input type="hidden" name="pageTransit" value="createJobCategory"/>
                                <button type="submit" class="btn btn-primary">Create Job Category</button>
                            </div>
                        </div>
                    </td>
                </tr>
