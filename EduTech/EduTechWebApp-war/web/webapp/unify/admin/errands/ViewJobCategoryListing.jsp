...
<html lang="en">
    <head>
        ...
        <title>Unify Admin - View Job Categories</title>
    ...
    <body class="nav-md">
                ...
                <div class="right_col" role="main">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_title">
                                <h2 class="bodyHeader">Job Categories</h2>
                                <ul class="nav navbar-right panel_toolbox">
                                    <li id="newJobCategory"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Job Category</li>
                                </ul>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
        ...
        <script src="js/unify/admin/webjs/errands/ViewJobCategoryListingJS.js" type="text/javascript"></script>
