...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="js/unify/admin/webjs/errands/ViewJobCategoryListingJS.js"></script>
    </head>
                ...
                <div class="container">
                    <div class="crumbs">
                        <ul id="breadcrumbs" class="breadcrumb">
                            ...
                            <li class="current">
                                ...
                                <a href="MarketplaceAdmin?pageTransit=goToViewJobCategoryListing">Errands (Job Categories)</a>
                            </li>
                        </ul>
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <h3>Job Categories</h3><span>Click on each job category to view the associated list of jobs.</span>
                        </div>
                        <ul class="page-stats">
                            <li>
                                <div class="summary"><span>Active Categories</span><h3><%= request.getAttribute("activeJobCategoryListCount")%></h3></div>
                                <div id="sparkline-bar2" class="graph sparkline hidden-xs">20,15,8,50,20,40,20,30</div>
                            </li>
                            <li>
                                <div class="summary"><span>Inactive Categories</span><h3><%= request.getAttribute("inactiveJobCategoryListCount")%></h3></div>
                                <div id="sparkline-bar" class="graph sparkline hidden-xs">20,15,8,50,20,40,20,30</div>
                            </li>
                            <li>
                                <div class="summary"><span>Job Listings</span><h3><%= request.getAttribute("jobListingCount")%></h3></div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="widget box">
                                <div class="widget-header">
                                    <h4><i class="fa fa-reorder"></i>&nbsp;Job Category Listing</h4>
                                    <div class="toolbar no-padding">
                                        <div class="btn-group">
                                            <span id="newJobCategory" class="btn btn-xs"><i class="fa fa-plus"></i>&nbsp;New Job Category</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="widget-content no-padding">
                                    <table id="jobCategoryListing" class="table table-striped table-bordered table-hover table-checkable table-responsive datatable">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <%
                                                String activeStatus = "";
                                                ArrayList<Vector> jobCategoryList = (ArrayList) request.getAttribute("jobCategoryList");
                                                if (!jobCategoryList.isEmpty()) {
                                                    for (int i = 0; i <= jobCategoryList.size()-1; i++) {
                                                        Vector v = jobCategoryList.get(i);
                    ...
                    <div id="newJobCategory-iframe"></div>
                    <div id="editJobCategory-iframe"></div>
                </div>
            </div>
        </div>
    </body>
