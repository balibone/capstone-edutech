    ...
    <body style="background-color: white;">
        ...
        <%
            ...
            String reportID, reportStatus, reportDescription, reportDate, reportedItemID,
                    reportedPosterID, reportedReporterID, itemName, itemDescription, itemImage;
            ...
            if (reportListVec != null) {
                ...
                if (reportListVec.size() > 7) {
                    itemName = (String.valueOf(reportListVec.get(7)));
                    itemDescription = (String.valueOf(reportListVec.get(8)));
                    itemImage = (String.valueOf(reportListVec.get(9)));
                }
            }
        %>
            ...
            <div id="formContent">
                <form action="ContentAdmin?pageTransit=goToReportedMarketplaceListing" method="GET" enctype="multipart/form-data" target="_parent">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Reported Item ID:&nbsp;&nbsp;<u><%= reportedItemID%></u></label>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">User ID of Item Poster:&nbsp;&nbsp;<u><%= reportedPosterID%></u></label>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Item Name:&nbsp;&nbsp;<u><%= itemName%></u></label>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Item Description:&nbsp;&nbsp;<u><%= itemDescription%></u></label>
                        </div>
