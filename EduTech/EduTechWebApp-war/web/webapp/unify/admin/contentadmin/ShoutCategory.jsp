...
<html lang="en">
    <head>
        ...
        <title>Unify Admin - Shout Category</title>
        ...
        <script type="text/javascript" src="js/unify/admin/webjs/contentadmin/ShoutCategoryJS.js"></script>
    </head>
                ...
                <div class="container">
                    <div class="crumbs">
                        <ul id="breadcrumbs" class="breadcrumb">
                            ...
                            <li class="current">
                                ...
                                <a href="ContentAdmin?pageTransit=goToShoutCategory">Shout Category</a>
                            </li>
                        </ul>
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <h3>Shout Category</h3><span>List of category for use by Shouts</span>
                        </div>
                        <ul class="page-stats">
                            <li>
                                <div class="summary"><span>Number of Categories</span><h3><%= request.getAttribute("tagsListCount")%></h3></div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="widget box">
                                <div class="widget-header">
                                    <h4><i class="fa fa-reorder"></i>&nbsp;List of Categories for Shouts</h4>
                                    <div class="toolbar no-padding">
                                        <div class="btn-group">
                                            <span id="newCat" class="btn btn-xs"><i class="fa fa-plus"></i>&nbsp;New Shout Category</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="widget-content no-padding">
                                    <table id="tagsList" class="table table-striped table-bordered table-hover table-checkable table-responsive datatable">
                                        <thead>
                                            <tr>
                                                <th data-class="expand">Category ID</th>
                                                <th data-class="expand">Category Name</th>
                                                <th data-hide="phone">Category Active?</th>
                                                <th data-hide="phone">Actions</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <%
                                                ArrayList<Vector> tagsList = (ArrayList) request.getAttribute("shoutCatList");
                                                if (!tagsList.isEmpty()) {
                                                    for (int i = 0; i <= tagsList.size()-1; i++) {
                                                        Vector v = tagsList.get(i);
                                                        String catID = String.valueOf(v.get(0));
                                                        String catName = String.valueOf(v.get(1));
                                                        String catStatus = String.valueOf(v.get(2));
                                            ...
                                            <tr>
                                                ...
                                                <td><%= catStatus%></td>
                                                <td>
                                                    <input type="button" value="Edit" class="btn btn-xs" style="margin-left: 4px" onclick="editCat(<%= catID%>)" target="_blank" />
                                                    <button type="submit" style="margin-left: 3px" class="btn btn-xs">
                                                        <a href="ContentAdmin?pageTransit=deleteCategory&categoryID=<%= catID%>" style="color: #333; text-decoration:none;"
                                                           onclick="return confirm('Confirm deletion of category?')">Delete</a>
                                                    </button>
                                                </td>
                                            </tr>
                                            <%      }   %>
                    ...
                    <div id="newCat-iframe"></div>
                    <div id="editCat-iframe"></div>
                </div>
            </div>
        </div>
    </body>
