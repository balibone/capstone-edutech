...
<html lang="en">
    <head>
        ...
        <title>Unify Admin - Company Reviews Reported Listing</title>
    ...
    <body class="nav-md">
                ...
                <div class="right_col" role="main">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_title">
                                <a href = "ContentAdmin?pageTransit=goToReportedReviewListing"><h2 class="bodyHeader">Company Reviews Reported Listing</h2></a>
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <%
                                            ArrayList<Vector> reportList3 = (ArrayList) request.getAttribute("reportReviewList");
                                            if (reportList3.isEmpty()) {
                                        %>

                                        <tr>
                                            <td colspan="8" style="text-align: center;">There are no items in marketplace reported.</td>
                                        </tr>
                                        <%
                                        } else {
        ...
        <script src="js/unify/admin/webjs/contentadmin/ReportedReviewListingJS.js" type="text/javascript"></script>
