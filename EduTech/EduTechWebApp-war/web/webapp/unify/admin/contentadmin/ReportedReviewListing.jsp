                ...
                <div class="container">
                    <div class="crumbs">
                        <ul id="breadcrumbs" class="breadcrumb">
                            ...
                            <li class="current">
                                ...
                                <a href="ContentAdmin?pageTransit=goToReportedReviewListing">List of Company Reviews Reported</a>
                            </li>
                        </ul>
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <a href = "ContentAdmin?pageTransit=goToReportedReviewListing"><h3>List of Company Reviews Reported</h3></a><span>Click on each report to view details.</span>
                        </div>
                        <ul class="page-stats">
                            <%-- dashboard view --%>
                            <li>
