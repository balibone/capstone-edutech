            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="col-md-12 col-sm-12 col-xs-5">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Reported Marketplace Listings</small></h2>
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-checkbox1" class="table table-striped table-bordered bulk_action">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="9" style="text-align: center;">There are no reported items available.</td>
                                        </tr>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-5">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Reported Errands Listings</small></h2>
                                <ul class="nav navbar-right panel_toolbox">
                                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                    </li>
                                    <li class="dropdown">
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-checkbox2" class="table table-striped table-bordered bulk_action">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="9" style="text-align: center;">There are no reported errands available.</td>
                                        </tr>
                                        <%
                                        } else {
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-5">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Reported Review Listings</small></h2>
                                <ul class="nav navbar-right panel_toolbox">
                                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                    </li>
                                    <li class="dropdown">
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="9" style="text-align: center;">There are no reported reviews available.</td>
                                        </tr>
                                        <%
                                        } else {
