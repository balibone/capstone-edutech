...
<html lang="en">
    <head>
        ...
        <script src="js/unify/admin/webjs/contentadmin/ReportedMarketplaceListingJS.js" type="text/javascript"></script>
    </head>
                ...
                <div class="container">
                    <div class="crumbs">
                        <ul id="breadcrumbs" class="breadcrumb">
                            ...
                            <li class="current">
                                ...
                                <a href="ContentAdmin?pageTransit=goToReportedMarketplaceListing">List of Marketplace Items Reported</a>
                            </li>
                        </ul>
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <a href = "ContentAdmin?pageTransit=goToReportedMarketplaceListing"><h3>List of Marketplace Items Reported</h3></a><span>Click on each report to view details.</span>
                        </div>
                        <ul class="page-stats">
                            <%-- dashboard view --%>
                            <li>
                                <div class="summary"><span>Unresolved Reports</span><h3><%= request.getAttribute("unresolvedItemReportCount")%></h3></div>
                                <div id="sparkline-bar4" class="graph sparkline hidden-xs">20,15,8,50,20,40,20,30</div>
                            </li>
                            <li>
                                <div class="summary"><span>Resolved Reports</span><h3><%= request.getAttribute("resolvedItemReportCount")%></h3></div>
