...
<html lang="en">
    <head>
        ...
        <title>Unify Admin - Marketplace Reported Listing</title>
                ...
                <div class="right_col" role="main">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_title">
                                <a href = "ContentAdmin?pageTransit=goToReportedMarketplaceListing"><h2 class="bodyHeader">Marketplace Reported Listing</h2></a>
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="7" style="text-align: center;">There are no items in marketplace reported.</td>
                                        </tr>
                                        <%
                                        } else {
