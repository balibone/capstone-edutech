...
<html lang="en">
    <head>
        ...
        <title>Unify Admin - List of Errands Reported</title>
                ...
                <div class="container">
                    <div class="crumbs">
                        <ul id="breadcrumbs" class="breadcrumb">
                            ...
                            <li class="current">
                                ...
                                <a href="ContentAdmin?pageTransit=goToReportedErrandsListing">List of Errands Reported</a>
                            </li>
                        </ul>
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <a href = "ContentAdmin?pageTransit=goToReportedErrandsListing"><h3>List of Errands Reported</h3></a><span>Click on each report to view details.</span>
                        </div>
                        <ul class="page-stats">
                            <%-- dashboard view --%>
                            <li>
