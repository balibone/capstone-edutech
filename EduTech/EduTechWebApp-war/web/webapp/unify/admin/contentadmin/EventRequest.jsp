...
<html lang="en">
    <head>
        ...
        <title>Unify Admin - Event Request List</title>
        ...
        <script src="js/unify/admin/webjs/contentadmin/EventRequestJS.js" type="text/javascript"></script>
    </head>
                ...
                <div class="container">
                    <div class="crumbs">
                        <ul id="breadcrumbs" class="breadcrumb">
                            ...
                            <li class="current">
                                ...
                                <a href="ContentAdmin?pageTransit=goToEventRequest">Event Request List</a>
                            </li>
                        </ul>
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <a href = "ContentAdmin?pageTransit=goToEventRequest"><h3>Event Request List</h3></a><span>Click on each request to view details.</span>
                        </div>
                        <ul class="page-stats">
                            <%-- dashboard view --%>
                            <li>
                            ...
                            <li>
                                <div class="summary"><span>Rejected Requests</span><h3><%= request.getAttribute("rejectedEventRequestCount")%></h3></div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="widget box">
                                <div class="widget-header">
                                    <h4><i class="fa fa-reorder"></i>&nbsp;Event Request List</h4>
                                ...
                                <div class="widget-content no-padding">
                                    <table id="eventRequestList" class="table table-striped table-bordered table-hover table-checkable table-responsive datatable">
                                        <thead>
                                            <tr>
                                                <th>Request ID</th>
                                                <th>Request Date</th>
