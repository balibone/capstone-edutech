...
<html lang="en">
    <head>
        ...
        <title>Unify Admin - Event Request Listing</title>
                ...
                <div class="right_col" role="main">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_title">
                                <a href = "ContentAdmin?pageTransit=goToEventRequest"><h2 class="bodyHeader">Event Request Listing</h2></a>

                                <div class="clearfix"></div>
                            </div>
                            
                            <%-- alert after approving or rejecting event request --%>
                            <div class="x_content">
                                <%
                                ...
                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="8" style="text-align: center;">There are no events requested.</td>
                                        </tr>
                                        <%
                                        } else {
