<!-- ***************************************************************************************
*   Title:                  TagListing.jsp
*   Purpose:                LIST OF TAGS (UNIFY ADMIN)
...
<html lang="en">
    <head>
        ...
        <title>Unify Admin - Tag List</title>
        ...
        <script type="text/javascript" src="js/unify/admin/webjs/contentadmin/TagListingJS.js"></script>
    </head>
                ...
                <div class="container">
                    <div class="crumbs">
                        <ul id="breadcrumbs" class="breadcrumb">
                            ...
                            <li class="current">
                                ...
                                <a href="ContentAdmin?pageTransit=goToTagListing">Tags List</a>
                            </li>
                        </ul>
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <h3>Tag List</h3><span>List of tags for use by the Unify System</span>
                        </div>
                        <ul class="page-stats">
                            <li>
                                <div class="summary"><span>Number of Tags</span><h3><%= request.getAttribute("tagsListCount")%></h3></div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="widget box">
                                <div class="widget-header">
                                    <h4><i class="fa fa-reorder"></i>&nbsp;Tags List</h4>
                                    <div class="toolbar no-padding">
                                        <div class="btn-group">
                                            <span id="newTag" class="btn btn-xs"><i class="fa fa-plus"></i>&nbsp;New Tag</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="widget-content no-padding">
                                    <table id="tagsList" class="table table-striped table-bordered table-hover table-checkable table-responsive datatable">
                                        <thead>
                                            <tr>
                                                <th data-class="expand">Tag ID</th>
                                                <th data-class="expand">Tag Name</th>
                                                <th data-hide="phone">Tag Type</th>
                                                <th data-hide="phone">Actions</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <%
                                                ArrayList<Vector> tagsList = (ArrayList) request.getAttribute("tagsList");
                                                if (!tagsList.isEmpty()) {
