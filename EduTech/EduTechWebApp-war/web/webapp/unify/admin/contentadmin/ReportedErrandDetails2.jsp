        ...
        <%
            ...
            if (reportListVec != null) {
                ...
                if (reportListVec.size() > 7) {
                    jobTitle = (String.valueOf(reportListVec.get(7)));
                    jobDescription = (String.valueOf(reportListVec.get(8)));
                    jobImage = (String.valueOf(reportListVec.get(9)));
                }
            }
        %>
            ...
            <div id="formContent">
                <form action="ContentAdmin?pageTransit=goToReportedErrandsListing" method="GET" enctype="multipart/form-data" target="_parent">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Reported Errand ID:&nbsp;&nbsp;<u><%= reportedErrandID%></u></label>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">User ID of Errand Poster:&nbsp;&nbsp;<u><%= reportedPosterID%></u></label>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">User ID of Reporter:&nbsp;&nbsp;<u><%= reportedReporterID%></u></label>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Job Title:&nbsp;&nbsp;<u><%= jobTitle%></u></label>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Job Description:&nbsp;&nbsp;<u><%= jobDescription%></u></label>
                        </div>
                        <%
                        } else {
                        %>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12"><b>ERRAND HAS BEEN DELETED FROM SYSTEM&nbsp;&nbsp;</b></label>
                        </div>
                        <%
                            }
                        %>
            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <table border="0" style="margin: auto;">
                        <tr>
                            <%
                                if (reportStatus.equals("Resolved") && !jobTitle.equals("")) {
                            %>
                            <td>
                                <form action="ContentAdmin?pageTransit=goToReportedErrandsListing" method="GET" target="_parent">
                                    <input type="hidden" name="pageTransit" value="unresolveErrandReport"/>
