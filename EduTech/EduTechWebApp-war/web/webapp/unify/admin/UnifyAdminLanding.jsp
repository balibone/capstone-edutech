...
<html lang="en">
    <head>
        ...
        <title>Unify - Admin Landing Page</title>
        
        <!-- Cascading Style Sheet (CSS) -->
        <link href="css/unify/admin/baselayout/bootstrap.min.css" rel="stylesheet" type="text/css">
        <link href="css/unify/admin/baselayout/basetemplate.css" rel="stylesheet" type="text/css">
        <link href="css/unify/admin/baselayout/font-awesome.min.css" rel="stylesheet" type="text/css">
        <link href="css/unify/admin/baselayout/CommonCSS.css" rel="stylesheet" type="text/css">
        
        <!-- JavaScript (JS) -->
        <script src="js/unify/admin/basejs/bootstrap.min.js" type="text/javascript"></script>
        <script src="js/unify/admin/basejs/jquery.min.js" type="text/javascript"></script>
        <script src="js/unify/admin/basejs/metisMenu.min.js" type="text/javascript"></script>
        <script src="js/unify/admin/basejs/jquery.newsTicker.js" type="text/javascript"></script>
        <script src="js/unify/admin/basejs/CommonJS.js" type="text/javascript"></script>
    </head>
                    ...
                    <div class="ccr-last-update">
                        ...
                        <div class="update-news-text">
                            <ul id="latestUpdate" class="newsticker">
                                ...
                                <li><strong>Welcome to Integrated Student System - Unify Admin!</strong></li>
