                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li><a href="Warehouse?pageTransit=goToNewContact"><i class="fa fa-user-plus fa-fw"></i>&nbsp;&nbsp;New Contact</a></li>
                                    <li><a href="Warehouse?pageTransit=goToNewEmployee"><i class="fa fa-user-plus fa-fw"></i>&nbsp;&nbsp;New Employee</a></li>
                                </ul>
                            </li>
                            <li>
                    ...
                    <form action="Warehouse" method="POST" class="form-horizontal zi-txn-form">
                        ...
                        <div class="row">
                            <div class="btn-toolbar col-md-5">
                                ...
                                <button class="btn btn-default" onclick="location.href='Warehouse?pageTransit=goToInvoiceList'" type="button">Cancel</button>
                            </div>
                        </div>
                    </form>
                </div>
