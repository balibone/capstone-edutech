        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="contentFill contentLayout" style="padding-top: 15px; height: 65px;">
                    ...
                    <button class="btn btn-primary pull-right" style="margin-right: 20px;" onclick="location.href='Warehouse?pageTransit=goToNewItem'">
                ...
                <div class="table-wrapper">			
                    ...
                    <table id="tblTarget" class="table table-responsive">
                        ...
                        <tbody>
                            ...
                            %>
                            <tr>
                                <td style="padding-left: 20px;"><img src="uploads/images/warehouse/Items/<%= itemImageDirPath %>" style="max-width: 70px; max-height: 70px;" /></td>
                                <td><%=itemName%></td>
                                <td><%=itemSKU%></td>
                                <td><%=itemSellingPrice%></td>
                                <td><%=itemQuantity.intValue()%></td>                               
                                <td>
                                    <a href='Warehouse?pageTransit=goToViewItem&itemSKU=<%=itemSKU%>' class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                                    <a href='Warehouse?pageTransit=goToEditItem&itemSKU=<%=itemSKU%>' class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                    <a onclick="return confirm_delete()" href="Warehouse?pageTransit=deleteItem&itemSKU=<%=itemSKU%>" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                                </td>
                            </tr>
                            <%}%>
                            <%}else{%>
